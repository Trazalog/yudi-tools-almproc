	...
	<div class="form-group">
		<center>
			...
			<label class="radio-inline">
				<input type="radio" name="result" id="Aprobar" value="ok" onclick="ocultarForm();"> Aprobar
			</label>
			<label class="radio-inline">
				<input type="radio" name="result" id="rechazo" value="" onclick="mostrarForm();"> Rechazar
			</label>
		</center>
	</div>
</form>
...
<script>
	...
	function modalCodigos() {
		...
		if (band == 0) {
			...
			arraydatos.fechaFormateada = fechaActual.toLocaleDateString();
		...
		$("td#fec_entrega").html("<strong>"+arraydatos.fechaFormateada+"</strong>");
